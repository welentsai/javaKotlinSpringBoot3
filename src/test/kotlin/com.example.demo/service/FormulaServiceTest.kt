...
class FormulaServiceTest (@Autowired val formulaService: FormulaService) {
    ...
    fun `save formula service`() {
        ...
        println("================")
        println(formulaService.findFormulaByCriteria("Draft", "N", null, null))
        println(formulaService.findFormulaByCriteria("Active", "DoNotCare", listOf(), null))
        println(formulaService.findFormulaByCriteria("Active", "Y", null, null))
        println(formulaService.findFormulaByCriteria("Active", null, listOf("Lab3"), null))
        println(formulaService.findFormulaByCriteria("Active", null, listOf("Lab2"), "Berry"))
        println(formulaService.findFormulaByCriteria("Active", null, listOf("Lab2"), "Juice"))
        println("================")
